...
async def add_node(node_type: str, properties: Dict[str, Any]):
    ...
    result = light_memory_client.add_node(node_type, properties)
    return result
...
async def add_relationship(start_node_id: str, end_node_id: str, rel_type: str, properties: Optional[Dict[str, Any]] = None):
    result = light_memory_client.add_relationship(start_node_id, end_node_id, rel_type, properties)
    return result
...
async def update_node(node_id: str, properties: Dict[str, Any]):
    result = light_memory_client.update_node(node_id, properties)
    return result
...
async def delete_node(node_id: str):
    result = light_memory_client.delete_node(node_id)
    return result
...
async def delete_relationship(start_node_id: str, end_node_id: str, rel_type: str):
    result = light_memory_client.delete_relationship(start_node_id, end_node_id, rel_type)
    return result
...
async def search_nodes(node_type: str, filters: Optional[Dict[str, Any]] = None):
    result = light_memory_client.search_nodes(node_type, filters)
    return result
...
async def search_relationships(start_node_id: str, end_node_id: str, rel_type: str):
    result = light_memory_client.search_relationships(start_node_id, end_node_id, rel_type)
    return result
